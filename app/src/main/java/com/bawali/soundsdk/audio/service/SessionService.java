package com.bawali.soundsdk.audio.service;
...
import com.bawali.soundsdk.audio.AudioUtils;
import com.bawali.soundsdk.audio.Constants;
import com.bawali.soundsdk.audio.MicrophoneListener;
import com.bawali.soundsdk.audio.StreamDecoder;
...
public class SessionService extends Service {
	...
	public static final int MSG_RECEIVED_GOOD_BROADCAST = 0;
	public static final int MSG_RECEIVED_BAD_BROADCAST = 1;
	public static final int MSG_RECEIVED_SOS = 2;
			...
			switch (msg.what) {
				...
				case (MSG_RECEIVED_SOS):
					if (haveCorrectBroadcast) {
						...
						//playData(correctBroadcast, SessionStatus.HELPING, tWait);
	...
	public void listen() {
		...
		Log.e("SessionService","Listening");
	}
