package com.bawali.soundsdk.audio;
...
/*
    //public static final double kLowFrequency = 10000; //the lowest frequency used
    //public static final double kFrequencyStep = 250; //the distance between frequencies
    ...
    //The frequencies we use for each of the 8 bits
    public static final int kBaseFrequency = 16000;
    //public static final int[] kFrequencies = {kBaseFrequency,14250, 14500, 14725, 15000,15250, 15500, 15750};
    public static final int[] kFrequencies = {16000,16200, 16400,16600,16800,17000,17200,17400};
  /*public static final int[] kFrequencies = {kBaseFrequency,   //1000
					    (int)(kBaseFrequency * (float)27/24), //1125
					    (int)(kBaseFrequency * (float)30/24), //1250
					    (int)(kBaseFrequency * (float)36/24), //1500
